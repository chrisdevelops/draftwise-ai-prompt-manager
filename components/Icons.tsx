...
export const ChipIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2h10a2 2 0 012 2v2" />
    </svg>
);

export const CompareIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.375a6.375 6.375 0 110-12.75 6.375 6.375 0 010 12.75zM12 18.375v2.625" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.625" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12h2.625" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h2.625" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.375a6.375 6.375 0 110-12.75 6.375 6.375 0 010 12.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25a.375.375 0 100-.75.375.375 0 000 .75z" />
    </svg>
);
